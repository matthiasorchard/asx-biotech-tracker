    ...
    return (
      <div className="min-h-[70vh] flex items-center justify-center">
        <div className="w-full max-w-sm text-center space-y-4">
          ...
          <Link href="/auth/login" className="inline-block text-sm text-green-500 hover:text-green-400">
            Back to sign in
          </Link>
        </div>
      </div>
    ...
    <div className="min-h-[70vh] flex items-center justify-center">
      <div className="w-full max-w-sm space-y-6">
        <div className="text-center">
          ...
          <h1 className="mt-2 text-xl font-semibold text-white">Create an account</h1>
        ...
        <form onSubmit={handleSignUp} className="space-y-4">
          ...
          <p className="text-xs text-slate-500">
            By signing up you agree this is a personal research tool, not financial advice.
          </p>
          <button
            type="submit"
            disabled={loading}
